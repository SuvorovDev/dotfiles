...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "r",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
    ...
    awful.key({ }, "Print", function()
              awful.spawn.with_shell("/home/disco/scripts/screenshot.sh")
              end),
    awful.key({ "Shift" }, "Print", function()
              awful.spawn.with_shell("/home/disco/scripts/screenshot-save.sh")
              end)  
)
